package br.com.caelum.stella.validation.ie
{
	...
	public class IESaoPauloComercioIndustriaValidator extends IEAbstractValidator {
		...
		public function IESaoPauloComercioIndustriaValidator(isFormatted:Boolean = true) {
			super(isFormatted);
		}
